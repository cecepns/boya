    ...
    <div className="relative notranslate" translate="no">
      ...
      <div className="relative notranslate" translate="no">
        <button
          ...
          className={`flex items-center space-x-2 md:py-1 rounded-md text-sm font-medium transition-colors ${
                ...
                return (
                  <button
                    ...
                    className={`flex items-center w-full px-4 py-2 text-sm transition-colors ${
                      isSelected
                        ? "bg-wood-dark text-amber-600"
                        : "text-gray-700 hover:bg-wood-dark hover:text-amber-600"
                    }`}
